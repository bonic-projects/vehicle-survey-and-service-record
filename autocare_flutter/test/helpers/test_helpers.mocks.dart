...
// in autocare_flutter/test/helpers/test_helpers.dart.
...
import 'package:autocare_flutter/services/database_service.dart' as _i8;
...
class MockDatabaseService extends _i1.Mock implements _i8.DatabaseService {
  ...
  @override
  void setVehicleId(String? id) => super.noSuchMethod(
        Invocation.method(
          #setVehicleId,
          [id],
        ),
  ...
  @override
  void setKm(int? km) => super.noSuchMethod(
        Invocation.method(
          #setKm,
          [km],
        ),
  ...
  @override
  void setupNodeListening() => super.noSuchMethod(
        Invocation.method(
          #setupNodeListening,
          [],
        ),
