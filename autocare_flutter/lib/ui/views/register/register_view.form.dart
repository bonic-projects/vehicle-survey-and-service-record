...
extension ValueProperties on FormStateHelper {
  ...
  bool get hasUserRole => this.formValueMap.containsKey(UserRoleValueKey);
  bool get hasEmail =>
  ...
  bool get hasUserRoleValidationMessage =>
      this.fieldsValidationMessages[UserRoleValueKey]?.isNotEmpty ?? false;
  ...
  String? get userRoleValidationMessage =>
      this.fieldsValidationMessages[UserRoleValueKey];
...
extension Methods on FormStateHelper {
  ...
  setUserRoleValidationMessage(String? validationMessage) =>
      this.fieldsValidationMessages[UserRoleValueKey] = validationMessage;
